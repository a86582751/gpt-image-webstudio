...
RANDOM_SCENE_SUMMARY_PROMPT = '请从下面这段AI绘画提示词中提取“地点和场景概述”。\n\n要求：\n1. 只输出一个简短中文短语，优先概括具体地点或空间，例如：书店、洗衣房、浴室、卧室、雨夜车站、便利店夜班。\n2. 不要输出人物、服装、镜头、画质、光影、风格等信息。\n3. 不要解释，不要加标题，不要使用句号。\n4. 如果没有明确地点，请输出最接近的场景概括。\n\n提示词：\n{{prompt}}'
